...
const Detail = ({ selectedProduct, setSelectedProduct }) => {
  return (
    <div className="fixed inset-0 flex items-center justify-center z-10 bg-black bg-opacity-50 ">
      <div className="max-w-md mx-auto bg-zinc-950 p-4 rounded-lg">
        ...
        />
        <h2 className="text-white font-bold mb-4">{selectedProduct.name}</h2>
        <p className="text-white">$ {selectedProduct.price} USD</p>
